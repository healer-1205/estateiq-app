...
class User {
  ...
  User({required this.name, required this.profilePhotoUrl});

  factory User.fromJson(Map<String, dynamic> json) {
    return User(name: json['name'], profilePhotoUrl: json['profile_photo_url']);
  }

  Map<String, dynamic> toJson() {
    return {'name': name, 'profile_photo_url': profilePhotoUrl};
  }
}
...
class Team {
  ...
  Team({required this.id, required this.name, required this.phoneNumbers});
