...
class Question2ConfirmScreen extends StatefulWidget {
  const Question2ConfirmScreen({super.key});

  @override
  State<Question2ConfirmScreen> createState() => _Question2ConfirmScreenState();
}

class _Question2ConfirmScreenState extends State<Question2ConfirmScreen>
                ...
                child: Column(
                  children: [
                    const Padding(
                      ...
                      child: Text(
                        "Nice! This opens up a lot of solid investment choices — I’ll make sure we explore the best ones.",
                        style: TextStyle(
                          fontSize: 16,
