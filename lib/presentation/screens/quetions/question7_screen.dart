import 'package:estate_iq/presentation/screens/quetions/question7_confirm_screen.dart';
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "You're almost ready to explore top property matches! One last thing - would you like me to calculate potential tax estimates for your investment? I can give you insights on rental income taxes or capital gains if you're planning to sell.",
                style: TextStyle(
                  fontSize: 16,
                      ...
                      onChanged: (val) {
                        setState(() {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Question7ConfirmScreen(),
                            ),
                          );
                        });
                      },
